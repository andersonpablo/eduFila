...
public class TelaInicial extends JFrame {
	...
	public TelaInicial() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(TelaInicial.class.getResource("/eduFila/img/icon.jpg")));
		...
		lblNewLabel.setIcon(new ImageIcon(TelaInicial.class.getResource("/eduFila/img/filaedu_300.png")));
